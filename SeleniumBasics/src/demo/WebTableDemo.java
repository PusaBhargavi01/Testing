...
public class WebTableDemo {
	...
	public static void main(String[] args) {
		...
		//4.1) Capture all the rows of the table and put them in alist
		List<WebElement> rows = firstTable.findElements(By.tagName("tr"));
		
		//4.2) From each row capture all the td elements in a separate list and then get the 2nd td elemnt
		//from the new list
		int sum =0;
